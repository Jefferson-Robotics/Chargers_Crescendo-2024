...
public class joystickControl extends CommandBase {
  ...
  private PWM_Motors m_subsystem;
  private Joystick leftShaft;
  private Joystick rightShaft;

  public joystickControl(PWM_Motors motorControl, Joystick leftShaft, Joystick rightShaft) {
  ...
  @Override
  public void execute() {
    m_subsystem.drive(leftShaft.getY(), rightShaft.getY());
  }
